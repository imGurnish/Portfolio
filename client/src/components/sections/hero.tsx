  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-6 gradient-text" data-testid="hero-title">
            Gurnish Singh Sangha
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-muted-foreground" data-testid="hero-subtitle">
            Computer Science Student & Cybersecurity Enthusiast
          </p>
          <p className="text-lg mb-12 text-muted-foreground max-w-2xl mx-auto" data-testid="hero-description">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="glass px-8 py-4 rounded-lg hover:bg-primary/20 transition-all duration-300 transform hover:scale-105"
            ...
            <button 
              ...
              className="bg-gradient-to-r from-primary to-secondary px-8 py-4 rounded-lg hover:opacity-80 transition-all duration-300 transform hover:scale-105"
